...
Deno.serve(async (req) => {
  console.log('🚀 get_roles function invoked');
  ...
  try {
    ...
    if (rolesError) {
      ...
      console.log('🔍 Error details:', JSON.stringify(rolesError, null, 2));
      return new Response(
    ...
    console.log('📈 Number of roles returned:', roles?.length || 0);
    console.log('👔 Roles data preview:', roles?.slice(0, 2));
